...
namespace CashRegister.Application.Services
{
	...
	{
		public bool ValidateBill(AddBillDto billDto)
		{
			if (!IsValidBillNumber(billDto.BillNumber))
				return false;
			if (!isValidCreditCard(billDto.CreditCardNumber))
				return false;
		...
		public bool IsValidBillNumber(string billNumber)
		{
			...
			var numberBody = long.Parse(billSubstring);
		...
		public bool ValidatePriceLimit(int price)
		{
